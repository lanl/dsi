...
clover_leaf_base_directory="/Users/ssakin/projects/CloverLeaf/CloverLeaf_ref"
MPI_THREADS=4
...
run_and_check_commit() {
    ...
    cd $base_directory
    python3 parse_clover_output.py --testname random_test --gitdir $clover_leaf_base_directory
