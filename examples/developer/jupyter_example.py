# examples/developer/jupyter_example.py
from dsi.core import Terminal

term = Terminal(debug = 0, backup_db = False, runTable = False) #do not need a runTable here

#read data
term.load_module('plugin', 'Schema', 'reader', filename="../test/example_schema.json")
term.load_module('plugin', 'YAML1', 'reader', filenames=["../test/student_test1.yml"])
