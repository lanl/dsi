...
test.read(filenames="data/yosemite.csv", reader_name='Csv')
test.read(filenames="data/wildfiredata.csv", reader_name='Wildfire') # makes a sim table automatically

test.read(filenames=['data/wildfire_datacard.yml', 'data/pennant_datacard.yml'], reader_name='Oceans11Datacard')
test.read(filenames="data/dublin_core_datacard.xml", reader_name='DublinCoreDatacard')
test.read(filenames="data/schema_org_datacard.json", reader_name='SchemaOrgDatacard')
...
test.backend("data.duckdb", backend_name="Sqlite")
