...
def FMNIST_evaluate(pathToGenerator, pathToDB, columnsofInterest, numImages, noiseDim, numberofSamples):
    gWorkflow = GAN()
...
if __name__ == '__main__':
      ...
      noise_dim = 100
      number_of_samples = 4
      FMNIST_evaluate(path_to_generator, path_to_db, columns_of_interest, num_of_images, noise_dim, number_of_samples)
