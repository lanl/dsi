...
if __name__ == "__main__":
    path_to_generator = 'mnist_untrained_models/gen.keras'
    path_to_discriminator = 'mnist_untrained_models/dis.keras'
    path_to_db = 'mnist.db'
    trained_models_folder = 'mnist_trained_models/'
    columns_of_interest = range(785)
    epochs = 2
    batch_size = 256
    noise = 100
    MNIST_train(path_to_generator, path_to_discriminator, path_to_db, columns_of_interest, epochs, batch_size, noise, trained_models_folder)
